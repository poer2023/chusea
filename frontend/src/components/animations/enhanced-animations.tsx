...
export const MicroInteraction = forwardRef<HTMLDivElement, MicroInteractionProps>(
  ({
    children,
    type = 'lift',
    intensity = 'normal', // eslint-disable-line @typescript-eslint/no-unused-vars
    disabled = false,
    className,
    ...props
  }, ref) => {
    ...
    const interactionClasses = useMemo(() => {
      ...
      // Intensity multiplier for future use
    ...
    }, [type, prefersReducedMotion, isLowPerformance, disabled]);
